# Discount IT Store Documentation
...
For getting started with the template you have to follow the below procedure. First navigate to the `discount-it` directory.
