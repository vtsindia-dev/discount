...
export default function ProductPopup() {
	...
	const { image, name, description, gallery, unique_id } = data;
	...
	function navigateToProductPage() {
		closeModal();
		router.push(`${ROUTES.PRODUCT}/${unique_id}`, undefined, {
	...
	const imageSrc = image?.original ?? gallery?.[0]?.original ?? "/assets/placeholder/products/product-thumbnail.svg";
	return (
