...
export default function Cart() {
	...
	const { closeCart, isCartLoading, isAuthorized, setModalView, openModal, setBuyNowProductId } = useUI();
		...
		<div className="flex flex-col w-full h-full justify-between">
			...
			>
				<div
					...
					className={cn(
						"w-full px-5 py-3 md:py-4 flex items-center justify-center bg-heading rounded-md text-sm sm:text-base text-white focus:outline-none transition duration-300 hover:bg-gray-600 cursor-pointer",
						{
			...
			{isCartLoading && <div className="bg-gray-200 bg-opacity-50 absolute w-full h-full">
